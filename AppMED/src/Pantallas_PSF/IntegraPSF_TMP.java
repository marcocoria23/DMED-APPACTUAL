            ...
            try {
                ...
                if (respuesta == JOptionPane.YES_OPTION) {
                    if (!RutaArchivo.getText().equals("")) {
                        muestra();
                        Elim.EliminaBD(CAño.getSelectedItem().toString());
                        jProgressBar1.setValue(5);
                        Ttabla.setText("TMP_GF_PROGRAMAS_SOCIALES_" + CAño.getSelectedItem().toString());
                        GF_PS.TR_GF_PROGRAMAS_SOCIALES(directorio + "programas_sociales.csv", CAño.getSelectedItem().toString());
                        jProgressBar1.setValue(50);
                        Ttabla.setText("TMP_GF_POBLACION_ATEND_MPIO_" + CAño.getSelectedItem().toString());
                        GF_PO.TR_GF_POBLACION_ATEND_MPIO(directorio + "poblacion_atendida_municipio.csv", CAño.getSelectedItem().toString());
                        jProgressBar1.setValue(75);
                        Ttabla.setText("TMP_GF_CONTRATACIONES_PUBLICAS" + CAño.getSelectedItem().toString());
                        GF_CON.TR_GF_CONTRATACIONES_PUBLICAS(directorio + "contratos.csv", CAño.getSelectedItem().toString());

 ...
 */
public class Crea_estructura extends javax.swing.JFrame {

    public static String YearTEPJF = "";

    public Crea_estructura() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Button_CreaEstructura.setText("Crear");
        ...
        Field_yearTEPJF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Field_yearTEPJFActionPerformed(evt);
            }
        });
    ...
    private void Button_CreaEstructuraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_CreaEstructuraActionPerformed
        ...
        int crear = JOptionPane.showConfirmDialog(
                Crea_estructura.this, // Usamos la ventana actual como padre
                "¿Está seguro de crear estructura TEPJF " + YearTEPJF + "?",
                "Confirmar creación de estructura",
                JOptionPane.YES_NO_OPTION
        );

        if (crear == JOptionPane.YES_OPTION) {
            CreaEstructura estructura = new CreaEstructura();
            try {
                estructura.CreaEstructura();
                JOptionPane.showMessageDialog(Crea_estructura.this, "La estructura ha sido creada");
            } catch (SQLException ex) {
                Logger.getLogger(Crea_estructura.class.getName()).log(Level.SEVERE, null, ex);
            }
            

        } else {

            JOptionPane.showMessageDialog(Crea_estructura.this, "Acción cancelada.");
        }
    ...
    private void Field_yearTEPJFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Field_yearTEPJFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Field_yearTEPJFActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Crea_estructura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Crea_estructura().setVisible(true);

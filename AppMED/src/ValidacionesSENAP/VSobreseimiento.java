...
public class VSobreseimiento {
    ...
    //ReglaNegocio 16.3. Si en el campo En caso de sobreseimiento, etapa en la que se dictó el sobreseimiento se requisito la opción "Investigación complementaria", entonces el campo Etapa en la que se dictó el sobreseimiento (columna AG) debera corresponder con la opción Etapa de investigación complementaria de la plantilla Proceso
    ...
    //ReglaNegocio 16.3. Si en el campo En caso de sobreseimiento, etapa en la que se dictó el sobreseimiento se requisito la opción "Investigación complementaria", entonces se deberá verificar que el campo Etapa en la que se dictó el sobreseimiento (columna AG) corresponda con la opción Etapa de investigación complementaria de la plantilla Proceso; además, que el campo ¿Se formuló acusación? (columna K) de la plantilla Investigación debe de traer la opción “No”
    ...
    //ReglaNegocio 16.3. Si en el campo En caso de sobreseimiento, etapa en la que se dictó el sobreseimiento se requisito la opción "Investigación complementaria", entonces se deberá verificar que el campo Etapa en la que se dictó el sobreseimiento (columna AG) corresponda con la opción Etapa de investigación complementaria de la plantilla Proceso; además, que el campo ¿Se formuló acusación? (columna K) de la plantilla Investigación complementaria se haya requisitado la opción “No”. Y también las plantillas Etapa intermedia, MASC y Sentencia no deberán ser requisitadas.
    ...
    //ReglaNegocio 16.5. La pestaña de sobreseimiento no debe contener información debido a que no se ha cumplimentado la suspensión condicional
    ...
    //ReglaNegocio 16.5. El campo Fecha en que se cumplimentó la suspensión condicional del proceso (columna J) debe ser menor al campo Fecha en que se dictó el sobreseimiento (columna G) de la plantilla Sobreseimiento.
    ...
    //ReglaNegocio 16.6. En caso de sobreseimiento, etapa en la que se dictó el sobreseimiento se requisito la opción "Etapa intermedia", entonces el campo Etapa procesal en la que se encuentra el imputado corresponda con la opción Etapa intermedia de la plantilla Proceso
    ...
    //ReglaNegocio 16.6. El campo ¿Se dictó auto de apertura a juicio oral?  (columna K) de la plantilla Etapa intermedia debe de ser la opción “No”
    ...
    //ReglaNegocio 16.6. Si se encuentran registros en la plantilla Sobreseimiento, no deberá existir información relacionada en las plantillas MASC, Suspensión condicional y Sentencia.
    ...
    // El campo Fecha en la que se dictó el sobreseimiento (columna G) debe ser mayor al campo Fecha de ingreso de la causa penal (columna K) de la plantilla Proceso. 
    ...
    //La FECHADICTOSOBRESEIMIENTO (Fecha de la celebración de la audiencia intermedia ) No debe de ser mayor a la fecha actual.

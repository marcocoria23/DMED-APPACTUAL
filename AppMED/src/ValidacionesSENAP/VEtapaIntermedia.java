...
public class VEtapaIntermedia {
    ...
    //El campo Fecha de escrito de la acusación (columna E) debera ser mayor o igual al campo Fecha de cierre de la investigación (columna J) de la plantilla Investigación complementaria.
    public ArrayList FECHAESCRITOACUSACION(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select EI.ENTIDADID, EI.PERIODO, EI.CARPETAID, EI.IMPUTADOID, EI.PROCESOID, EI.ETAPAINTERMEDIAID, EI.FECHAESCRITOACUSACION, IC.FECHACIERREINV\n"
                ...
                + "where EI.FECHAESCRITOACUSACION < IC.FECHACIERREINV AND (EI.FECHAESCRITOACUSACION<>'01/01/1900') and (IC.FECHACIERREINV<>'01/01/1900') AND (EI.ENTIDADID='" + Entidad + "' AND EI.PERIODO='" + Periodo + "')";
    ...
    //El campo ¿Hubo celebración de audiencia intermedia? (columna F) es requisitado con la opcion "Si" (1) entonces el campo Fecha de la celebración de la audiencia intermedia (columna G) debe ser requisitado. 
    public ArrayList HUBOCELAUDINTER(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select ENTIDADID, PERIODO, CARPETAID, IMPUTADOID, PROCESOID, ETAPAINTERMEDIAID, HUBOCELAUDINTER, FECHACELAUDINTER\n"
                ...
                + "and FECHACELAUDINTER is null AND (ENTIDADID='" + Entidad + "' AND PERIODO='" + Periodo + "')";
        System.out.println(sql);
        Query = sql;
        resul = conexion.consultar(sql);
        try {
    ...
    //El campo Fecha de la celebración de la audiencia intermedia (columna G) debera ser mayor al campo Fecha de audiencia inicial (columna I) de la plantilla Proceso.
    public ArrayList FECHACELAUDINTER(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select EI.ENTIDADID, EI.PERIODO, EI.CARPETAID, EI.IMPUTADOID, EI.PROCESOID, EI.ETAPAINTERMEDIAID, EI.FECHACELAUDINTER, P.FECHAAUDIENCIAINICIAL\n"
                ...
                + "where EI.FECHACELAUDINTER <= P.FECHAAUDIENCIAINICIAL AND (EI.FECHACELAUDINTER<>'01/01/1900') and (P.FECHAAUDIENCIAINICIAL<>'01/01/1900') AND (EI.ENTIDADID='" + Entidad + "' AND EI.PERIODO='" + Periodo + "')";
        System.out.println(sql);
        Query = sql;
        resul = conexion.consultar(sql);
        try {
    ...
    //El campo El campo ¿Hubo celebración de audiencia intermedia? (columna F) es requisitado con la opción “No” (2) o "No identificado" (9), entonces la plantilla Sobreseimiento debe ser requisitada.
    ...
    //El campo ¿Hubo presentación de medios de prueba? (columna H) es requisitado con la opción “Si” (1), entonces el campo Medios de prueba (columna I) debe ser requisitado. 
    ...
    //El campo ¿Hubo presentación de medios de prueba? (columna H) es diferente a la opción “Si” (1), entonces el campo Medios de prueba (columna I) no debe ser requisitado.
    ...
    //El campo ¿Hubo celebración de audiencia intermedia? (columna F) es requisitado con la opcion "Si" (1), entonces el campo ¿Contó con acuerdos probatorios? (columna J) debe ser requisitado con la opcion "Si" (1). 
    ...
    //ReglaAdicional 14.9.1. El campo ¿Se dictó auto de apertura a juicio oral? (columna K) se requisito con la opción "Sí" (1) debe ser requisitada la plantilla Sentencia.
    ...
    //ReglaAdicional 14.9.1. El campo ¿Se dictó auto de apertura a juicio oral? (columna K) es diferente de la opción "Sí" (1) no debe ser requisitada la plantilla Sentencia.
    ...
    //La FECHACELAUDINTER (Fecha de la celebración de la audiencia intermedia ) No debe de ser mayor a la fecha actual.
...
////Regla Adicional Favor de verificar el campo ¿Se dictó auto de apertura a juicio oral?	DICTAUTAPERJUICIO debido a que no se puede seleccionar una opcion diferente a "Si" (1), "No" (2), "No identificado" (9).

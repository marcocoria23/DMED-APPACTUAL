...
public class VInvestigacionComplementaria {
    ...
    //ReglaNegocio 12.2. El campo ¿Hubo formulación de la imputación? (columna E) no es requisitado con la opción “Si” (1), entonces el campo Fecha de formulación de la imputación (columna F) no deberá ser requisitada.
    ...
    //El campo Resolución del auto de vinculación a proceso (columna G) es requisitado con la opción diferente a "Vinculación a proceso" (1) no deberá registrarse la Fecha en que se dictó el auto de vinculación (columna H).
    ...
    //El campo Resolución del auto de vinculación a proceso (columna G) es requisitado con la opción "Vinculación a proceso" (1) debe registrarse la Fecha en que se dictó el auto de vinculación (columna H).
    ...
    //El campo Fecha en que se dictó el auto de vinculación (columna H) debe ser mayor o igual a la Fecha de formulación de la imputación (columna F).
    ...
    //ReglaNegocio 12.5. El campo ¿Se impuso medida cautelar? (columna G) es requisitado con la opcion "Si" (1) debera ser requistada la plantilla Medidas cautelares.
    ...
    //ReglaNegocio 2.18.2. El campo ¿Se impuso medida cautelar? (columna I) es requisitado con la opción "NO" (1), NO deberá ser requisitada la plantilla Medidas cautelares.
    ...
    //El campo Fecha de cierre de la investigación (columna J) debe ser mayor o igual al campo Fecha en que se dictó auto de vinculación (columna H).
    ...
    //-----campo:    Acusacion ----------------***
    //ReglaNegocio 2.18.3. El campo ¿Se formuló acusación? (columna K) es requisitado con la opcion "Si" (1) debera ser requisitada la plantilla Etapa intermedia. 
    ...
    //ReglaAdicional 20.1.3. El campo ¿Se formuló acusación? (columna K) es es requisitado con la opción “No” (2) debe ser requisitada la plantilla MASC.
    ...
    //ReglaAdicional 20.1.3. El campo ¿Se formuló acusación? (columna K) es es requisitado con la opción “No” (2) deberá ser requisitada la plantilla Suspensión condicional.
    ...
    //La FECHACIERREINV (Fecha  del cierre de la investigación ) No debe de ser mayor a la fecha actual.
    ...
    //La FECHAFORMIMP (Fecha de formulación de la imputación ) No debe de ser mayor a la fecha actual.
    ...
    //La FECHAVINCPROS (Fecha en que se dictó el auto de vinculación a proceso (aplica si se vinculó a proceso) ) No debe de ser mayor a la fecha actual.
 ...
 //Regla Adicional -- Favor de verififcar el campo ¿Hubo formulación de la imputación?	FORMULACIONIMPUTACION debido a que no puede seleccionar una opción diferente a "Si" (1), "No" (2) y "No identificado" (3).
...
//Regla Adicional -- Favor de verififcar el campo ¿Se formuló acusación?	ACUSACION debido a que no puede seleccionar una opción diferente a "Si" (1), "No" (2) y "No identificado" (3).
...
//Regla Adicional -- Favor de verififcar el campo ¿Se impuso medida cautelar? MEDIDACAUTELAR debido a que no puede seleccionar una opción diferente a "Si" (1), "No" (2) y "No identificado" (9).
...
"where ACUSACION not in (1,2,9) or ACUSACION is null"
    ...
    public ArrayList NoVincProceso_omitirsiguientes(String Entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        Array = new ArrayList();
    ...
    public ArrayList NoVincProceso_sobreseimiento(String Entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        Array = new ArrayList();

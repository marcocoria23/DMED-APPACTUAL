...
public ArrayList ID_COMISION_LEGISLATIVA(String ID_entidad,String Legislatura,String Envio){
     conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT P1_3A_120,P1_3A_122 ,P1_2_1,C1_3A_ID,Legislatura,ID_ENTIDAD FROM(\n" +
"select P.P1_3A_120,P.P1_3A_122 ,S.P1_2_1,P.C1_3A_ID,P.Legislatura,P.ID_ENTIDAD from TR_PLE_MEDS1_3A P LEFT JOIN\n" +
"TR_PLE_MEDS1_2 S \n" +
...
public ArrayList ID_PERSONA_LEGISLADORA(String ID_entidad,String Legislatura,String Envio){
     conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT P1_3A_120,P1_3A_121 ,P1_3_1,C1_3A_ID,Legislatura,ID_ENTIDAD FROM(\n" +
"select P.P1_3A_120,P.P1_3A_121 ,S.P1_3_1,P.C1_3A_ID,P.Legislatura,P.ID_ENTIDAD from TR_PLE_MEDS1_3A P LEFT JOIN\n" +
"TR_PLE_MEDS1_3 S \n" +
"ON P.ID_ENTIDAD= S.ID_ENTIDAD\n" +
...
public ArrayList Cant_Reuniones(String ID_entidad,String Legislatura,String Envio){
     conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT P1_3A_120,P1_3A_125 ,P1_2_15,C1_3A_ID,Legislatura,ID_ENTIDAD FROM(\n" +
"select P.P1_3A_120,P.P1_3A_125 ,S.P1_2_15,P.C1_3A_ID,P.Legislatura,P.ID_ENTIDAD from TR_PLE_MEDS1_3A P LEFT JOIN\n" +
"TR_PLE_MEDS1_2 S \n" +
"ON P.ID_ENTIDAD= S.ID_ENTIDAD\n" +
"AND P.C1_3A_ID=  S.C1_2_ID\n" +
"AND P.LEGISLATURA=S.LEGISLATURA\n" +

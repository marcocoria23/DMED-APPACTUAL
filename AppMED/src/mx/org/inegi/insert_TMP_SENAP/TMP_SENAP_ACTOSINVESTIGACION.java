...
public class TMP_SENAP_ACTOSINVESTIGACION {
    ...
    public void TMP_SENAP_ACTOSINVESTIGACION(String Entidad, String Periodo) throws Exception {
        ...
        try {
            ...
            if (CFilas > 0) {
                sd = StructDescriptor.createDescriptor("OBJ_TMP_SENAP_ACTOSINVESTIGACION", con);
                ...
                descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_TMP_SENAP_ACTOSINVESTIGACION", con);
                System.out.println("entro 3");
                array_to_pass = new ARRAY(descriptor, con, structs);
                System.out.println("entro 4");
                st = con.prepareCall("{? = call(PKG_INTEGRADOR_SENAP_BAK.TMP_SENAP_ACTOSINVESTIGACION(?))}");

...
public class TMP_SENAP_MEDIDASCAUTELARES {
    ...
    public void TMP_SENAP_MEDIDASCAUTELARES(String Entidad, String Periodo) throws Exception {
        ...
        try {
            ...
            if (CFilas > 0) {
                sd = StructDescriptor.createDescriptor("OBJ_TMP_SENAP_MEDIDASCAUTELARES", con);
                ...
                descriptor = ArrayDescriptor.createDescriptor("ARR_OBJ_TMP_SENAP_MEDIDASCAUTELARES", con);

...
public class BeanTEMP_TR_TEPJF_RESPONSABLES extends Bean implements SQLData {

    private String SQLTypeName;
    private String ID_TEMP_TEPJF_EXPEDIENTE;
    private String ID_TEMP_TEPJF_RESPONSABLES;
    ...
    public String GetID_TEMP_TEPJF_RESPONSABLES() {
        return ID_TEMP_TEPJF_RESPONSABLES;
    }

    public void SetID_TEMP_TEPJF_RESPONSABLES(String ID_TEPJF_RESPONSABLES) {
        this.ID_TEMP_TEPJF_RESPONSABLES = ID_TEPJF_RESPONSABLES;
    }

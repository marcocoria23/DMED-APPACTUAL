 ...
 */
package mx.org.inegi.ExportaXlsm.PSF;
...
public class Exporta_errores_insert {
   ...
   public void exportarExcel(JTable tabla, String Año) throws FileNotFoundException, IOException {
        try (Workbook libroExcel = new XSSFWorkbook()) {
            ...
            estiloEncabezado.setFillForegroundColor(IndexedColors.DARK_YELLOW.getIndex());
            ...
            d.setFile("PSF_Exporta_Año_" + Año + ".xlsx");
            d.setVisible(true);

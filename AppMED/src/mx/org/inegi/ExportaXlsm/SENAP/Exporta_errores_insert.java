 ...
 */
package mx.org.inegi.ExportaXlsm.SENAP;
 ...
 */
public class Exporta_errores_insert {
    
   public void exportarExcel(JTable tabla, String Entidad, String Periodo) throws FileNotFoundException, IOException {
        try (Workbook libroExcel = new XSSFWorkbook()) {
            ...
            estiloEncabezado.setFillForegroundColor(IndexedColors.DARK_RED.getIndex());
            ...
            d.setFile("SENAP_Exporta_Ent_" + Entidad + "_Periodo_" + Periodo + ".xlsx");
            d.setVisible(true);

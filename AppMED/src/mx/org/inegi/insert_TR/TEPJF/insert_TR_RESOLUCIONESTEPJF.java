 ...
 */
public class insert_TR_RESOLUCIONESTEPJF {
    
    
      public void InsertTR_Resoluciones() throws SQLException{
    CallableStatement st;
      ...
      try {
         ...
         st = con.prepareCall("{call PKG_CARGA_TEPJF2.PM_TR_TEPJF_RESOLUCIONES()}");

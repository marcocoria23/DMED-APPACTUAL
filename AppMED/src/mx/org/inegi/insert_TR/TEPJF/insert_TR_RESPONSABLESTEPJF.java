 ...
 */
public class insert_TR_RESPONSABLESTEPJF {
    
   public void InsertTR_Responsables() throws SQLException{
    CallableStatement st;
      ...
      try {
         ...
         st = con.prepareCall("{call PKG_CARGA_TEPJF2.PM_TR_TEPJF_RESPONSABLES()}");

 ...
 */
public class TR_ple_meds1_1A {
 
    
      public void TR_ple_meds1_A(String Entidad,String Legislatura,String Envio) throws SQLException{
      ...
      try {
         ...
         st = con.prepareCall("{call PKG_CARGA_PLE2.PM_PLE_MEDS1_1A(?, ?, ?)}");

 ...
 */
public class Tmp_ple_meds1_1B {

    public void Tmp_ple_meds1_1B(String Entidad, String Envio, String Legislatura) throws Exception {
        ...
        try {
            ArrayList<BeanTMP_PLE_MEDS1_1B> ad = new ArrayList<>();
            ...
            c.SetENTIDAD(Entid);
            c.SetP1_1B_1(xlsm.LeerExcel(32, 12));
            c.SetP1_1B_2(xlsm.LeerExcel(32, 27));
            c.SetLEGISLATURA_TMP(Legislatura);
            c.SetC1_IB_TMP(Envio);
            ad.add(c);

            for (BeanTMP_PLE_MEDS1_1B elemento : ad) {
                System.out.println("ID_ENTIDAD_TMP: " + elemento.GetID_ENTIDAD_TMP());
                System.out.println("ENTIDAD: " + elemento.GetENTIDAD());
                System.out.println("P1_1B_1: " + elemento.GetP1_1B_1());
                System.out.println("P1_1B_2: " + elemento.GetP1_1B_2());
                System.out.println("LEGISLATURA_TMP: " + elemento.GetLEGISLATURA_TMP());
                System.out.println("C1_IB_TMP: " + elemento.GetC1_1B_ID_TMP());
                System.out.println("------------------------------------------------");
            }
            ...
            //JOptionPane.showMessageDialog(null, "Registros insertados en tabla TMP_PLE_MEDS1_1B, Favor de revisar pantalla Erores de insert");  
        } finally {
            try {
                array_to_pass = null;
                structs = null;

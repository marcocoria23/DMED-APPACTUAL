...
public class ExportaPVictimaImputado {
    ...
    public void exportaPVictimaImputado(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PVictimaImputado.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PVictimaImputado se ha exportado satisfactoriamente!");

...
public class ExportaPDeterminacion {
    ...
    public void exportaPDeterminacion(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PDeterminacion.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PDeterminacion se ha exportado satisfactoriamente!");

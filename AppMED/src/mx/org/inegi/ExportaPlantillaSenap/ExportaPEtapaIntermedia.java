...
public class ExportaPEtapaIntermedia {
    ...
    public void exportaPEtapaIntermedia(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PEtapaIntermedia.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PEtapaIntermedia se ha exportado satisfactoriamente!");

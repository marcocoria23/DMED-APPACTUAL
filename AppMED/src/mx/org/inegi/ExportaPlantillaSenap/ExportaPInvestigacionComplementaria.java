...
public class ExportaPInvestigacionComplementaria {
    ...
    public void exportaPInvestigacionComplementaria(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PInvestigacionComplementaria.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PInvestigacionComplementaria se ha exportado satisfactoriamente!");

...
public class ExportaPSuspensionCondicional {
    ...
    public void exportaPSuspensionCondicional(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PSuspensionCondicional.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PSuspensionCondicional se ha exportado satisfactoriamente!");

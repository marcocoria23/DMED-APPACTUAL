...
public class ExportaPMandamientosJudiciales {
    ...
    public void exportaPMandamientosJudiciales(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PMandamientosJudiciales.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PMandamientosJudiciales se ha exportado satisfactoriamente!");

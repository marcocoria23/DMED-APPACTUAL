...
public class ExportaPSobreseimiento {
    ...
    public void exportaPSobreseimiento(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PSobreseimiento.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PSobreseimiento se ha exportado satisfactoriamente!");

...
public class ExportaPMASC {
    ...
    public void exportaPMASC(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PMASC.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PMASC se ha exportado satisfactoriamente!");

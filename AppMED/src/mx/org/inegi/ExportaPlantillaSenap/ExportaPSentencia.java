...
public class ExportaPSentencia {
    ...
    public void exportaPSentencia(String Entidad, String Periodo) throws SQLException {
        ...
        fileDialog.setFile("PSentencia.csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PSentencia se ha exportado satisfactoriamente!");

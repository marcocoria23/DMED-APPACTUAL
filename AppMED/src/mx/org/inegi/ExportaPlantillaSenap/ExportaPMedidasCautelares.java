 ...
 */
public class ExportaPMedidasCautelares {

    private ConOracle conexion = new ConOracle();
    private ResultSet resul;

    public void exportaPMedidasCautelares (String Entidad, String Periodo) throws SQLException {
        ...
        String sql = "SELECT \n"
                ...
                + "IMPUTADOID, \n"
                + "PROCESOID,  \n"
                + "CONVERI_MEDIDA(CATMEDIDAID)CATMEDIDAID,\n"
        ...
        fileDialog.setFile("PMedidasCautelares .csv"); // Nombre del archivo
        ...
        if (fileName != null && directory != null) {
            ...
            try ( PrintWriter writer = new PrintWriter(new FileWriter(csvFile))) {
                ...
                JOptionPane.showMessageDialog(null, "El archivo con nombre PMedidasCautelares  se ha exportado satisfactoriamente!");

...
public class VDeterminacion {
    ...
    //ReglaAdicional 9.3.2. Si el sentido de la determinación es requisitado con la opción  "Ejercicio de la acción penal" se deberá permitir el registro del campo "Fecha de la determinación" (columna H) y se continuará con el registros de la plantilla Proceso".
    ...
    //ReglaDMED. La FECHADETERMINACION (Fecha de la determinación ) No debe de ser mayor a la fecha actual.
    ...
    //ReglaNegocioAdicional 19.1.2. El campo Estatus de la carpeta de investigación (columna C) es requisitado con el valor “Concluida” (1) entonces en el campo Sentido de la determinación (columna D) solo se pueden seleccionar las opciones “No ejercicio de la acción penal por la actualización de alguna causal de sobreseimiento”; “Abstenerse de investigar cuando se encuentre extinguida la acción penal o la responsabilidad penal de la persona imputada”; “Abstenerse de investigar cuando las conductas no constituyan delito”; “Abstenerse de investigar no identificado”; “Criterios de oportunidad en los que se decretó la extinción de la acción penal”, “Incompetencia”, “Acuerdos reparatorios aprobados por el Ministerio Público en los que se decretó la extinción de la acción penal” y “Acumulación”.    
    ...
    //ReglaAdicionalAdicional 9.2.5. Si el campo Estatus de la carpeta de investigación   (columna D), es requisitado con la opción “No identificado”, entonces en el campo Sentido de la determinación (columna E) únicamente deberá contar con el valor “No identificado
    ...
    //ReglaNegocioAdicional 9.2.6. Si  el campo Estatus de la carpeta de investigación” (columna D), corresponde a “Trámite”, entonces las determinaciones válidas en el campo Sentido de determinación (columna E) a las cuales podrá ser actualizada son: “Ejercicio de la Acción Penal”, “Archivo temporal”, “Otro” y “No identificado”; este último para el caso de las carpetas de investigación que al inicio de su apertura aún no cuenten con un sentido de determinación
    ...
    //ReglaNegocio 9.2.1. Si el campo Estatus de la carpeta de investigación (columna D) es requisitado con el valor “Concluida”, en el campo Sentido de la determinación (columna E), podrán registrarse únicamente las opciones: “No ejercicio de la acción penal por la actualización de alguna causal de sobreseimiento”; “Abstenerse de investigar cuando se encuentre extinguida la acción penal o la responsabilidad penal de la persona imputada”; “Abstenerse de investigar cuando las conductas no constituyan delito”; “Abstenerse de investigar no identificado”; “Criterios de oportunidad en los que se decretó la extinción de la acción penal”, “Incompetencia”, “Acuerdos reparatorios aprobados por el Ministerio Público en los que se decretó la extinción de la acción penal” y “Acumulación”
    ...
    //ReglaNegocioAdicional 19.1.3. Si el campo Estatus de la carpeta de investigación (columna D) es requisitado con la opción “En proceso de conclusión (trámite)”, el campo Sentido de la determinación (columna E) podrá registrar las opciones “Ejercicio de la acción penal”; “Archivo temporal” u “Otro”.
    ...
    //ReglaNegocioAdicional 20.1.7. Si en el campo Estatus de la carpeta de investigación (columna D) se especifica la opción “Concluida”, se deberá corroborar la existencia de información en la plantilla MASC
    ...
    //ReglaNegocioAdicional 20.1.7. Si en el campo Estatus de la carpeta de investigación (columna D) se especifica la opción “Concluida”, se deberá corroborar la existencia de información en la plantilla sobreseimiento
    ...
    //ReglaNegocioAdicional 9.6. Si el sentido de la determinación es requisitado con la opción “Archivo temporal", no podra venir vacio el campo "En caso de archivo temporal, ¿hubo reactivación de la carpeta de investigación?" (columna G)
    ...
    //ReglaNegocioAdicional 9.3. Si el sentido de la determinación es requisitado con la opción  "Ejercicio de la acción penal" el campo "Fecha de la determinación" (columna H) no puede venir vacio
    ...
    //ReglaNegocioAdicional 9.4. Sí es requisitada la plantilla "Sobreseimiento", el campo Sentido de la determinación debe ser requisitado con las opciones: "No ejercicio de la acción penal por la actualización de alguna causal de sobreseimiento", "Abstenerse de investigar cuando se encuentre extinguida la acción penal o la responsabilidad penal de la persona imputada", "Abstenerse de investigar cuando las conductas no constituyan delito”, “Abstenerse de investigar no identificado”, “ Criterios de oportunidad en los que se decretó la extinción de la acción penal”, “Incompetencia”, “Acumulación” u “Otro”.
    ...
    //ReglaAdicional 9.3.1. Si el sentido de la determinación es diferente a la opción "Ejercicio de la acción penal" no debe registrar en el campo "Fecha de la determinación" (columna H) y no debe existir registros en la plantilla Proceso.
    ...
    //ReglaNegocioAdicional 9.2.2. Si el Sentido de la determinación (columna E) se ingresó con la opción de “Reactivación” (columna G), su estatus subsecuente solo podrá ser: “Ejercicio de la Acción Penal”, “No ejercicio de la acción penal”, “Archivo Temporal”, “Abstenerse de investigar cuando se encuentre extinguida la acción penal o la responsabilidad penal de la persona imputada”, “Abstenerse de investigar cuando las conductas no constituyan algún delito”, “Abstenerse de investigar no identificado”, “Criterio de oportunidad en los que se decretó la extinción de la acción penal”, “Incompetencia”, “Acuerdos reparatorios aprobados por el Ministerio Público en los que se decretó la extinción de la acción penal”, “Acumulación”, “Otro”
    ...
    //ReglaNegocioAdicional 20.1.8. Si el valor del campo Etapa procesal en que se encuentra la carpeta de investigación (columna AG) de la plantilla Carpeta de investigación es “Etapa de investigación complementaria”, el campo Sentido de la determinación (columna E), deberá ser requisitado con una de las siguientes opciones: “Ejercicio de la acción penal”; “Criterios de oportunidad en los que se decretó la extinción de la acción penal”; “Incompetencia”; “Acuerdos reparatorios aprobados por el Ministerio Público en los que se decretó la extinción de la acción penal”; o “No identificado”.
    ...
    //ReglaDEMED. Favor de verificar el campo Estatus de la carpeta de investigación CATESTATUSCARPETAID no puede seleccionar una opción diferente a "Concluida" (1), "En proceso de conclusión (trámite)" (2) y "No identificado" (3)..
    ...
    //ReglaDMED. Favor de verificar el campo Sentido de la determinación  CATSENDETID no puede venir nulo.
    ...
    //ReglaDMED. Favor de verificar el campo Fecha de la determinación (aplica también para fecha de reactivación en caso de archivo temporal y criterio de oportunidad)  FECHADETERMINACION debido a que no puede venir nulo.

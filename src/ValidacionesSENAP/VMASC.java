...
public class VMASC {
    ...
    //ReglaDMED La FECHADERIVAMASC (Fecha en que se deriva a MASC) No debe de ser mayor a la fecha actual.
    ...
    //ReglaDMED La FECHACUMPLIMENTOMASC (Fecha en que se cumplimentó el MASC) No debe de ser mayor a la fecha actual.
    ...
    //ReglaNegocio 15.4.1. El campo Fecha en que se cumplimentó la suspensión condicional del proceso (columna H) no es requisitada, debe ser requisitada la plantilla MASC. 
    ...
    //ReglaNegocio 15.2. El campo Tipo de cumplimiento (columna G) es requisitado, entonces el campo Fecha en la que se cumplimentó el MASC (columna H) debe ser requisitado. 
    ...
    //ReglaNegocio 15.2.1. El campo Tipo de cumplimiento (columna G) no es requisitado, entonces el campo Fecha en la que se cumplimentó el MASC (columna H) no debe ser requisitado. 
    ...
    //ReglaNegocio 15.1. El campo Fecha en la que se cumplimentó el MASC (columna H) debera ser mayor al campo Fecha en que se deriva el MASC (columna E).

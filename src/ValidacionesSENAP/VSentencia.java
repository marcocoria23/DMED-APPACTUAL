...
public class VSentencia {
    ...
    //ReglaNegocio 18.7.1. El campo Fecha en que se cumplimentó la suspensión condicional del proceso (columna H) no es requisitada y el campo ¿Hubo reapertura del proceso? (columna H) sea requisitado con la opcion “SÍ” (1), entonces la plantilla Sentencia no debe ser requisitada.
    ...
    //ReglaNegocioAdicional 18.8.1. El campo ¿Hubo reapertura del proceso? HUBOREAPERTURAPROCESO es requisitada con la opción “SÍ” (1) y el campo Fecha en que se cumplimentó la suspensión condicional del proceso FECHACUMPSUSPENCONDIPROCESO no debe ser requisitada, así como la tabla TR_SENAP_SENTENCIA debe ser requisitada. 
    ...
    //ReglaNegocio 18.9. La plantilla Sentencia es requisitada y el campo Etapa procesal en la que se encuentra el imputado (columna AG) se requisito con la opción “Etapa de juicio” (4), en el campo ¿Se dictó auto de apertura a juicio oral? (columna k) de la plantilla Etapa Intermedia debe ser requisitado la opción “Si” (1) y el campo ¿La sentencia fue derivada de un procedimiento abreviado? (columna G) debe ser requisitada con la opción “No” (2).
    ...
    //ReglaNegocio 18.1. El campo Fecha de celebración de la audiencia del juicio (columna E) debe ser mayor al campo Fecha de la celebración de la audiencia intermedia (columna G) de la plantilla Etapa intermedia.
    ...
    //ReglaNegocio 18.2. El campo ¿La Sentencia fue derivada de un procedimiento abreviado? (columna G) es requisitado con la opción “Si” (1), entonces el campo Fecha en que se dictó el procedimiento abreviado (columna H) debe ser requisitado. 
    ...
    //ReglaNegocio 18.3. El campo Fecha de la celebración de la audiencia de juicio (columna E) es requisitado, entonces el campo Fecha en que se dictó el procedimiento abreviado (columna H) no debe ser requisitado.
    ...
    //ReglaNegocio 18.5. El campo ¿Se dictó auto de apertura a juicio oral? (columna K) de la plantilla Etapa intermedia no debe ser requisitado con la opción Si" (1), entonces el campo Fecha en que se dictó el procedimiento abreviado (columna H) no debe ser requisitado.
    ...
    //ReglaNegocio 18.4. El campo Fecha en que se dictó la sentencia (columna I) debe ser mayor o igual al campo Fecha de la celebración de la audiencia de juicio (columna E).
    ...
    //ReglaDMED. La FECHACELEBAUDIJUICIO (Hace referencia del día, mes y año de la celebración de la audiencia de juicio) No debe de ser mayor a la fecha actual.
    ...
    //ReglaDMED. La FECHADICTOSENTENCIA (Hace referencia del día, mes y año en que se dictó la resolución del estudio de fondo del asunto, por parte del tribunal de enjuiciamiento) No debe de ser mayor a la fecha actual.

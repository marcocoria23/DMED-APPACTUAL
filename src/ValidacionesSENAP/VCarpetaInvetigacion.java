...
public class VCarpetaInvetigacion {
    ...
    //ReglaDMED. La relación entre los campos  CatEntidadFederativaID (Entidad) y CATMUNICIPIOID (Municipio) de la plantilla Carpeta Investigación, no coinciden con la relación de los campos CATENTIDADFEDERATIVAID y CATMUNICIPIODEMARCACIONTERRITORIALID del catálogo SENAP_MUNICIPIODEMARCACIONTERRITOR
    ...
    //ReglaDEMED. La Fecha de presentación de la denuncia o querella (columna U) no puede ser mayor a la Fecha Actual.
    ...
    //ReglaNegocio 2.13. Debe existir registro en la plantilla Actos de Investigación, debido que en el campo ¿Se realizaron actos de investigación? (columna AA) se respondió con un “Sí” (1).
    ...
    //ReglaNegocio 2.13.1. No debe existir registro en la plantilla Actos de Investigación, debido que en el campo ¿Se realizaron actos de investigación? (columna AA) se respondió con una opción diferente a “Sí” (1).
    ...
    //ReglaNegocio 2.7. La cantidad de imputados registrados en la tabla Imputado no coincide con la cantidad que se ingresó en la plantilla Carpeta de investigación.
    ...
    //ReglaNegocio 2.11.1. El campo Cantidad de personas imputadas (columna AD) de la tabla Imputado no coincide con la cantidad de registros de la plantilla Carpeta de investigación.
    ...
    //ReglaAdicional 2.20. Si el campo ¿Tipo de hecho por el que se abrió la carpeta de investigación? se seleccionó una opción diferente a "Hecho no constitutivo de delito” (2), no deberá haber registros en la plantilla Delitos.
    ...
    //ReglaNegocio 2.10. Debe existir registros en la plantilla Actos de Investigación ya que el campo ¿Se realizaron aseguramientos? (columna AF) se requisito la opción “Sí” (1).
    ...
    //ReglaNegocio 2.10.1. No debe existir registros en la plantilla Actos de Investigación ya que el campo ¿Se realizaron aseguramientos? (columna AF) es diferente de la opción “Sí” (1).
    ...
    //ReglaDMED. Favor de verificar variable FECHACARINVE-Fecha de apertura de la carpeta de investigación  ya que la variable es de prioridad 1 y no puede venir null 
    ...
    //ReglaDMED. Favor de verificar variable HORAPECARINVE-Hora en la que el ministerio público abrió carpeta de investigación  ya que la variable es de prioridad 1 y no puede venir null
    ...
    //ReglaDMED. Favor de verificar variable CATHECHOCIID-Tipo de hecho por el que se abrió la carpeta de investigación en su codigo diferente de 1 a 3 ya que la variable es de prioridad 1
...
//ReglaDMED. Favor de verificar variable CATETAPAPROCESALID-Etapa procesal en que se encuentra la carpeta de investigación en su codigo diferente de 1 a 5 ya que la variable es de prioridad 1
    ...
    // ReglaAdicional 2.20. Si el campo ¿Tipo de hecho por el que se abrió la carpeta de investigación? se seleccionó una opción diferente a "Hecho no constitutivo de delito” (2), no deberá haber registros en la plantilla Delitos.
    public ArrayList TIPOHECHOABREIOCI(String Entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select \n"
                + "ci.ENTIDADID, ci.PERIODO,\n"

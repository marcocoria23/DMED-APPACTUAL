...
public class VProceso {
    ...
    //ReglaDMED 10.18 La FECHAINICIO (Fecha de ingreso de la causa penal) No debe de ser mayor a la fecha actual.
    ...
    //ReglaDMED 10.19 La FECHAAUDIENCIAINICIAL (Fecha de la audiencia inicial) No debe de ser mayor a la fecha actual.
    ...
    //ReglaDMED 10.20 La FECHAULTIMOESTATUSPROCESO (Fecha ultimo estatus proceso) No debe de ser mayor a la fecha actual.
    ...
    //ReglaAdicional 10.7.1 El campo Etapa procesal en la que se encuentra el imputado (columna E) es requisitado con la opcion “Etapa de investigación inicial” (1) entonces la plantilla Determinación debe ser requisitado.
    ...
    //ReglaAdicional 10.7.2 El campo Etapa procesal en la que se encuentra el imputado (columna E) es requisitado con la opcion “Etapa de investigación inicial” (1) entonces la plantillas Investigación complementaria, Medidas cautelares, Etapa intermedia, Suspensión condicional, Sobreseimiento y Sentencia deben ser requisitadas.
    ...
    //ReglaAdicional 10.8 El campo Etapa procesal en la que se encuentra el imputado (columna E) es “Etapa de investigación inicial” (1), entonces los campos Estatus de la carpeta de investigación (columna D) y Sentido de la determinación (columna E) de la plantilla Determinación deberán ser requisitados.
    ...
    //ReglaAdicional 10.9 El campo Etapa procesal en la que se encuentra el imputado (columna E) es requisitado con la opción “Etapa de investigación complementaria” (2) entonces las plantillas Determinación, Mandamientos judiciales e Investigación complementaria deben ser requisitadas.
    ...
    //ReglaAdicional 10.10 El campo Etapa procesal en la que se encuentra el imputado (columna E) corresponde a la opción “Etapa intermedia” (3), entonces las plantillas Determinación, Proceso, Mandamientos judiciales, Investigación complementaria y Etapa intermedia deben ser requisitadas. 
    public ArrayList CATETAPAPROCESALID3(String Entidad, String Periodo) throws SQLException {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select P.ENTIDADID, P.PERIODO, P.CARPETAID, P.IMPUTADOID, P.PROCESOID, P.CATETAPAPROCESALID, D.TABLA_DETERMINACION, MJ.TABLA_MANDAMIENTOSJUDICIALES, IC.TABLA_INVESTIGACIONCOMPLEMENTARIA, EI.TABLA_ETAPAINTERMEDIA \n"
                + "from TR_SENAP_PROCESO P\n"
                + "LEFT JOIN ( \n"
                + "   SELECT ENTIDADID, PERIODO, CARPETAID,  \n"
                + "   COUNT (CARPETAID) AS TABLA_DETERMINACION \n"
                ...
                + "  or TABLA_MANDAMIENTOSJUDICIALES IS NULL\n"
    ...
    //ReglaAdicional 10.11 El campo Etapa procesal en la que se encuentra el imputado (columna E) es requisitado con la opción “Etapa intermedia” (3), entonces el campo ¿Se formuló acusación? (columna K) de la plantilla Investigación complementaria debe ser requisitada la opción "Si" (1).
    ...
    //ReglaAdicional 10.12.1 El campo Etapa procesal en la que se encuentra el imputado (columna E) corresponde a la opción “Etapa de juicio” (4), entonces el campo ¿Se dictó auto de apertura a juicio oral? (columna K) debe ser requisitado la opción “Sí” (1) de la plantilla Etapa Intermedia.
    ...
    //ReglaAdicional 10.12.2 El campo Etapa procesal en la que se encuentra el imputado (columna E), corresponde a la opción “Etapa de juicio” (4), entonces las plantillas  Determinación, Mandamientos judiciales, Investigación complementaria y Etapa Intermedia deben ser requisitadas.
    public ArrayList CATETAPAPROCESALID4(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select P.ENTIDADID, P.PERIODO, P.CARPETAID, P.IMPUTADOID, P.PROCESOID, P.CATETAPAPROCESALID, D.TABLA_DETERMINACION, MJ.TABLA_MANDAMIENTOSJUDICIALES, IC.TABLA_INVESTIGACIONCOMPLEMENTARIA, EI.TABLA_ETAPAINTERMEDIA\n"
                ...
                + "  or EI.TABLA_ETAPAINTERMEDIA is null) \n"
                + "  AND (P.ENTIDADID='" + Entidad + "' AND P.PERIODO='" + Periodo + "'  )";
        System.out.println(sql);
        Query = sql;
        resul = conexion.consultar(sql);
    ...
    //ReglaAdicional 10.13 El campo Etapa procesal en la que se encuentra el imputado (columna E), corresponde a la opción “Etapa de juicio” (4), entonces el campo Sentido de la determinación (columna E) de la plantilla Determinación deberá ser requisitado con una de las siguientes opciones “Ejercicio de la acción penal” (1) o “No identificado” (99).
    ...
    //ReglaAdicional 10.14 El campo Etapa procesal en la que se encuentra el imputado (columna E), corresponde a la opción “Etapa de juicio” (4) y el campo Estatus de la carpeta de investigación (columna D) de la plantilla Determinación tiene el valor “Concluida” (1), no debe existir información en las plantillas Suspensión condicional (cumplimentada), MASC y Sobreseimiento.
    ...
    //ReglaNegocio 10.2. El campo ¿Hubo celebración de audiencia inicial? (columna G) es requisitado con la opción “Si” (1), entonces el campo Fecha de la audiencia inicial (columna I) debera ser requisitado. 
    ...
    //ReglaAdicional 10.17.1 El campo ¿Hubo celebración de audiencia inicial? (columna G) es requisitado con la opción "Sí" (1) debe permitir el registro de las plantillas Mandamientos judiciales e Investigación complementaria.
    ...
    //ReglaAdicional 10.17.2 El campo ¿Hubo celebración de audiencia inicial? (columna G) es requisitado con la opción "Sí" (1) no debe ser requistado el campo Motivo por el que no se celebró la audiencia inicial.
    ...
    //ReglaNegocio 10.3. El campo ¿Hubo celebración de audiencia inicial? (columna G) es requisitado con la opcion "No" (2) entonces los campos Motivo por el que no se celebró la audiencia inicial (columna H) debe ser requisitado y el campo Fecha de la audiencia inicial (columna I) no debe ser requisitado.
    ...
    //ReglaNegocio 10.4. El campo Fecha de audiencia inicial (columna I) debe ser mayor o igual a la Fecha de ingreso de la causa penal (columna F).
    ...
    //ReglaNegocio 10.5. El campo ¿El asunto fue derivado a MASC? (columna J) es requisitado con la opcion "Si" (1) debe ser requisitada la plantilla MASC.
    ...
    //ReglaNegocio 10.6. El campo ¿Se dictó suspensión condicional del proceso? (columna K) es requisitado con la opcion "Si" (1) debe ser requisitada la plantilla Suspensión Condicional.
    ...
    //ReglaNegocio 9.2.5 El campo Estatus de carpeta CATESTATUSCARPETAID es requisitado con la opción “No identificado” (9) no debe existir información en las plantillas MASC, Sobreseimiento, Suspensión condicional y Sentencia.
    ...
    //ReglaNegocio 9.2.6 El campo Estatus de carpeta  es requisitado con la opción “Trámite” (2) para cualquier etapa del campo Etapa procesal en la que se encuentra la determinacion  no debe existir información en las plantillas MASC, Sobreseimiento, Suspensión condicional y Sentencia.
    ...
    //ReglaNegocio 19.1.2 El campo  Estatus de la carpeta  es requisitado con el valor “Concluido”, en la etapa de investigación inicial, debe existir información en alguna de las siguientes plantillas MASC o Sobreseimiento.
    ...
    //ReglaNegocio 19.1.3 Si el campo Estatus del proceso  es requisitado con el valor “Concluido”, en la etapa de investigación complementaria, se deberá verificar que exista información en alguna de las siguientes plantillas. MASC, Suspensión condicional o Sobreseimiento 
    public ArrayList CATESTATUSCARPETAID5(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select * from (\n"
                ...
                + "where p.CATESTATUSCARPETAID=1 and p.CATETAPAPROCESALID=2) where suma>1 "
    ...
    //ReglaNegocio 19.1.4 Si el campo Estatus del proceso  es requisitado con el valor “Concluido”, en la etapa intermedia, se deberá verificar que exista información en alguna de las siguientes plantillas: MASC, Suspensión condicional, Sobreseimiento o Sentencia.
    public ArrayList CATESTATUSCARPETAID6(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select * from (\n"
                ...
                + "where p.CATESTATUSCARPETAID=1 and p.CATETAPAPROCESALID=3) where suma>1 "
                + "AND (ENTIDADID='" + Entidad + "' AND PERIODO='" + Periodo + "'  )";
        System.out.println(sql);
        Query = sql;
        resul = conexion.consultar(sql);
    ...
    //ReglaNegocio 19.1.5 Si el campo Estatus del proceso  es requisitado con el valor “Concluido”, en la etapa de juicio, se deberá verificar que exista información en alguna de las siguientes plantillas: Sobreseimiento o Sentencia.
    public ArrayList CATESTATUSCARPETAID7(String Entidad, String Periodo) throws SQLException {
        ...
        sql = "select * from (\n"
                ...
                + "CARPETAID,IMPUTADOID,PROCESOID,PERIODO\n"
                + "))sen on sen.ENTIDADID=p.ENTIDADID and sen.CARPETAID=p.CARPETAID and sen.PROCESOID=p.PROCESOID and sen.PERIODO=p.PERIODO\n"
                + " where p.CATESTATUSCARPETAID=1 and p.CATETAPAPROCESALID=4) where suma>1 "
                + "AND (ENTIDADID='" + Entidad + "' AND PERIODO='" + Periodo + "'  )";
        System.out.println(sql);
        Query = sql;
        resul = conexion.consultar(sql);

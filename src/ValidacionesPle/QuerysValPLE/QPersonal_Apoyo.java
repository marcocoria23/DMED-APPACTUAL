...
"    FROM TR_PLE_MEDS1_4)\n" +
"SELECT ID_ENTIDAD, envio, LEGISLATURA, ID_Actual, ID_CORRECTO FROM ESTRUCTURA_id WHERE ID_Actual <> ID_CORRECTO AND  (Legislatura="+Legislatura+" and ID_ENTIDAD="+ID_entidad+"  AND  envio='"+Envio+"')\n" +
"UNION \n" +

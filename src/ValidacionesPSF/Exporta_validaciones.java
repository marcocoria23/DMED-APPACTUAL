...
//estiloCelda2.setVerticalAlignment(VerticalAlignment.LEFT);
    ...
    public void Despliega_Programas_Sociales(XSSFWorkbook libro, XSSFSheet hojaExpedientes, XSSFCellStyle estiloCelda0, XSSFCellStyle estiloCelda1, XSSFCellStyle estiloCeldabordes0, JProgressBar progressBar) {
        ...
        ArrayResult = PS.URL_REGLAS_LINEAMIENTOS_OPERACIONDC();
        ...
        ArrayResult = PS.URL_REGLAS_LINEAMIENTOS_OPERACIONNDC();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.derecho_social_atendido_2();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.derecho_social_atendido_3();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.derecho_social_atendido_4();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.derecho_social_atendido_5();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.tipo_apoyo_entregado_2();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.tipo_apoyo_entregado_3();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.tipo_apoyo_entregado_4();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.tipo_apoyo_entregado_5();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.OTRO_TIPO_APOYO_ENTREGADO_ESPECIFIQUE();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.OTRO_TIPO_APOYO_ENTREGADO_ESPECIFIQUEND();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.poblacion_atendida_territorial_especifique();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.poblacion_atendida_otro_tipo_especifique();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.poblacion_atendida_otro_tipo_especifiqueND();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.grupo_ESPECIFIQUE();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = PS.grupo_ESPECIFIQUEND();
        if (ArrayResult.size() > 0) {
    ...
    public void Despliega_Contrataciones_Publicas(XSSFWorkbook libro, XSSFSheet hojaContrataciones, XSSFCellStyle estiloCelda0, XSSFCellStyle estiloCelda1, XSSFCellStyle estiloCeldabordes0, JProgressBar progressBar) {
        ...
        ArrayResult = CP.otro_tipo_procedimiento_especifique();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = CP.otro_tipo_procedimiento_especifiqueNDC();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = CP.fecha_publicacion_fallo();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = CP.fecha_firma_contrato();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = CP.fecha_inicio_contrato();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = CP.fecha_conclusion_contrato();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = CP.tipo_garantia_presentada_1();
        if (ArrayResult.size() > 0) {
        ...
        ArrayResult = CP.tipo_garantia_presentada_1_ND();
        if (ArrayResult.size() > 0) {

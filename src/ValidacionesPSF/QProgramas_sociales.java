...
public class QProgramas_sociales {
    ...
    public ArrayList URL_REGLAS_LINEAMIENTOS_OPERACIONDC() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select ID_PROGRAMA_SOCIAL,COND_REGLAS_LINEAMIENTOS_OPERACION, URL_REGLAS_LINEAMIENTOS_OPERACION,REPLACE(COMENTARIOS,',','')COMENTARIOS from TR_GF_PROG_SOCIALES_GEN\n"

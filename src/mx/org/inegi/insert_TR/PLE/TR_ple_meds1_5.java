 ...
 */
public class TR_ple_meds1_5 {
    
    
    public void TR_ple_meds1_5(String Entidad,String Legislatura,String Envio) throws SQLException{
      ...
      try {
         ...
         st = con.prepareCall("{call PKG_CARGA_PLE2.PM_PLE_MEDS1_5(?, ?, ?)}");

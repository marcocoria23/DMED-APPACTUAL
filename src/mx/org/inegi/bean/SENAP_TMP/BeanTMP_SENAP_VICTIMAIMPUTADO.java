 ...
 */
public class BeanTMP_SENAP_VICTIMAIMPUTADO extends Bean implements SQLData {

    private String SQLTypeName;
    private String ENTIDADID;
    private String VICTIMAIMPUTADOID;
    private String VICTIMAIMPUTADOID_FISCALIA;
    ...
    private String CATTIPORELACIONID;
    ...
    public String GetVICTIMAIMPUTADOID() {
        return VICTIMAIMPUTADOID;
    }

    public void SetVICTIMAIMPUTADOID(String VICTIMAIMPUTADOID) {
        this.VICTIMAIMPUTADOID = VICTIMAIMPUTADOID;
    }

    public String GetVICTIMAIMPUTADOID_FISCALIA() {
        return VICTIMAIMPUTADOID_FISCALIA;
    }

    public void SetVICTIMAIMPUTADOID_FISCALIA(String VICTIMAIMPUTADOID_FISCALIA) {
        this.VICTIMAIMPUTADOID_FISCALIA = VICTIMAIMPUTADOID_FISCALIA;
    }
    ...
    public String GetCATTIPORELACIONID() {
        return CATTIPORELACIONID;
    }

    public void SetCATTIPORELACIONID(String CATTIPORELACIONID) {
        this.CATTIPORELACIONID = CATTIPORELACIONID;
    }
    ...
    public Object[] toArray() {
        Object[] array = {
            GetENTIDADID(),
            GetVICTIMAIMPUTADOID(),
            GetVICTIMAIMPUTADOID_FISCALIA(),
            GetCATFISCALIAID(),
            GetVICTIMAID(),
            GetIMPUTADOID(),
            GetVICTIMAID_FISCALIA(),
            GetIMPUTADOID_FISCALIA(),
            GetCATTIPORELACIONID(),
            GetBORRADO(),
            GetFECHAALTA(),
            GetUSUARIOALTA(),
            GetFECHACORTE(),

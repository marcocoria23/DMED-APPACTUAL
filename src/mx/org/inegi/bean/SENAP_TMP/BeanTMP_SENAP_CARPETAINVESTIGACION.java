 ...
 */
public class BeanTMP_SENAP_CARPETAINVESTIGACION extends Bean implements SQLData {
    ...
    public String GetFECAPECARINVE() {
        return FECAPECARINVE;
    }

    public void SetFECAPECARINVE(String FECAPECARINVE) {
        this.FECAPECARINVE = FECAPECARINVE;
    }

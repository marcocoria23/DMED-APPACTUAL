 ...
 */
public class ProcCreaDinamica {
    public void CreaTabDinamica(int Anio) throws SQLException{
        ...
        try {
            ...
            st = con.prepareCall("{call CREARTABLASDINAMICAS(?)}"); //CREARTABLASDINAMICAS

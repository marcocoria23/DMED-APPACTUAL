 ...
 */
package mx.org.inegi.ExportaXlsm.TEPJF;
...
public class Exporta_errores_insert {
    ...
    public void exportarExcel(JTable tabla) throws FileNotFoundException, IOException {
        try (Workbook libroExcel = new XSSFWorkbook()) {
            ...
            d.setFile("PLE_Exporta_ErroresIn_TEPJF"+".xlsx");
            d.setVisible(true);

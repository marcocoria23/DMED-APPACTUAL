        ...
        try {
            ...
            for (int i = 0; i < fila.size(); i++) {
                ...
                ArrayList<String> filaActual = fila.get(i);
                    ...
                    c.SetPROCESOID(filaActual.get(9));
                    c.SetPROCESOID_FISCALIA(filaActual.get(10));
                    c.SetFORMULACIONIMPUTACION(filaActual.get(11));
                    c.SetFECHAFORMIMP(filaActual.get(12));
                    c.SetCATVINCPROSID(filaActual.get(13));
                    c.SetFECHAVINCPROS(filaActual.get(14));
                    c.SetMEDIDACAUTELAR(filaActual.get(15));
                    c.SetFECHACIERREINV(filaActual.get(16));
                    c.SetACUSACION(filaActual.get(17));
                    c.SetBORRADO(filaActual.get(18));
                    c.SetFECHAALTA(filaActual.get(19));
                    c.SetUSUARIOALTA(filaActual.get(20));
                    c.SetCATFISCALIAID(filaActual.get(21));

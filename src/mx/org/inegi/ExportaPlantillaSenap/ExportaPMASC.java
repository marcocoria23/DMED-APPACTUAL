 ...
 */
public class ExportaPMASC {

    private ConOracle conexion = new ConOracle();
    private ResultSet resul;

    public void exportaPMASC(String Entidad, String Periodo, String csvFile) throws SQLException {
        ...
        String sql = "SELECT \n"
                ...
                + "PROCESOID,\n"
                + "IMPUTADOID,\n"
                + "CONVERI_AUTORIDADDERIVAMASC(CATAUTORIDADDERIVAMASCID)CATAUTORIDADDERIVAMASCID,\n"
                + "TO_CHAR(FECHADERIVAMASC,'DD/MM/YYYY')FECHADERIVAMASC,\n"
                + "CONVERI_TIPOMASC(CATTIPOMASCID)CATTIPOMASCID,\n"
                + "CONVERI_TIPOCUMPLIMIENTO(CATTIPOCUMPLIMIENTOID)CATTIPOCUMPLIMIENTOID,\n"
                + "TO_CHAR(FECHACUMPLIMENTOMASC,'DD/MM/YYYY')FECHACUMPLIMENTOMASC,\n"
        ...
        encabezados.add("MASCID ");
        encabezados.add("CarpetaID");
        encabezados.add("ProcesoID");
        encabezados.add("ImputadoID ");
        encabezados.add("Autoridad que deriva el MASC ");
        encabezados.add("Fecha en que se deriva a MASC");
        encabezados.add("Tipo de MASC ");
        encabezados.add("Tipo de cumplimiento ");
        encabezados.add("Fecha en que se cumplimentó el MASC");
        encabezados.add("Monto de la reparación del daño");

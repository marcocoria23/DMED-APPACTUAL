 ...
 */
public class ExportaPMandamientosJudiciales {

    private ConOracle conexion = new ConOracle();
    private ResultSet resul;

    public void exportaPMandamientosJudiciales(String Entidad, String Periodo, String csvFile) throws SQLException {
        ...
        String sql = "SELECT \n"
                ...
                + "IMPUTADOID,\n"
                + "PROCESOID,\n"
                + "TO_CHAR(FECHASOLMANDJUD,'DD/MM/YYYY')FECHASOLMANDJUD,\n"
                + "CONVERI_TIPOMANDAMIENTO(CATTIPOMANDAMIENTOID)CATTIPOMANDAMIENTOID,\n"
                + "TO_CHAR(FECHALIBMAND)FECHALIBMAND,\n"
                + "CONVERI_ESTATUSMANDAMIENTOJUDICIAL(ULTESTMAND)ULTESTMAND,\n"
                + "TO_CHAR(FECHAULTESTMAND)FECHAULTESTMAND,\n"
...
encabezados.add("MandamientoJudicialID");
encabezados.add("CarpetaID");
encabezados.add("ImputadoID ");
encabezados.add("ProcesoID");
encabezados.add("Fecha de solicitud del mandamiento judicial");
encabezados.add("Tipo de mandamiento");
encabezados.add("Fecha de libramiento del mandamiento ");
encabezados.add("Estatus de mandamiento judicial");
encabezados.add("Fecha de cumplimiento del mandamiento");

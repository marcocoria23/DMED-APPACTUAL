...
public class ExportaPMedidasCautelares {
    ...
    public void exportaPMedidasCautelares(String Entidad, String Periodo, String csvFile) throws SQLException {
        ...
        encabezados.add("MedidaCautelarID ");
        encabezados.add("CarpetaID");
        encabezados.add("ImputadoID ");
        encabezados.add("ProcesoID");
        encabezados.add("Tipo de medidas cautelares impuestas ");

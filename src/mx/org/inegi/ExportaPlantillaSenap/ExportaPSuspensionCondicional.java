 ...
 */
public class ExportaPSuspensionCondicional {

    private ConOracle conexion = new ConOracle();
    private ResultSet resul;

    public void exportaPSuspensionCondicional(String Entidad, String Periodo, String csvFile) throws SQLException {
        ...
        String sql = "SELECT  \n"
                ...
                + "IMPUTADOID,\n"
                + "PROCESOID,\n"
                + "TO_CHAR(FECHADICSUSCONPRO,'DD/MM/YYYY')FECHADICSUSCONPRO,\n"
                + "CONVERI_ETAPASUSPENSIONCONDICIONAL(CATSUSCONID)CATSUSCONID,\n"
                + "CONVERI_TIPOCONDICIONESIMPUESTASSUSP(CATCONDIMPUSUSPENCONDIPROCESOID)CATCONDIMPUSUSPENCONDIPROCESOID,\n"
                + "CONVERI_RESPUESTASGENERICAS(HUBOREAPERTURAPROCESO)HUBOREAPERTURAPROCESO,\n"
                + "TO_CHAR(FECHAREAPERTURAPROCESO,'DD/MM/YYYY')FECHAREAPERTURAPROCESO,\n"
                + "TO_CHAR(FECHACUMPSUSPENCONDIPROCESO,'DD/MM/YYYY')FECHACUMPSUSPENCONDIPROCESO,\n"
                + "SUSPENSIONCONDICIONALID_FISCALIA,\n"
                + "PERIODO\n"
                + "FROM \n"
                + "TR_SENAP_SUSPENSIONCONDICIONAL"
        ...
        encabezados.add("SuspensiónCondicionalID");
        encabezados.add("CarpetaID");
        encabezados.add("ImputadoID ");
        encabezados.add("ProcesoID");
        encabezados.add("Fecha en que se dictó la suspensión condicional del proceso  ");
        encabezados.add("Etapa en la que se dictó  la suspensión condicional del proceso  ");
        encabezados.add("Tipo de condiciones impuestas durante la suspensión condicional del proceso");
        encabezados.add("¿Hubo reapertura del proceso?");
        encabezados.add("Fecha de la reapertura del proceso ");
        encabezados.add("Fecha en que se cumplimentó la suspensión condicional del proceso  ");

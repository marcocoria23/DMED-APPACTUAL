 ...
 */
public class ExportaPEtapaIntermedia {

    private ConOracle conexion = new ConOracle();
    private ResultSet resul;

    public void exportaPEtapaIntermedia(String Entidad, String Periodo, String csvFile) throws SQLException {
        ...
        String sql = "SELECT \n"
                ...
                + "IMPUTADOID, \n"
                + "PROCESOID, \n"
                + "TO_CHAR(FECHAESCRITOACUSACION,'DD/MM/YYYY')FECHAESCRITOACUSACION, \n"
                + "CONVERI_RESPUESTASGENERICAS(HUBOCELAUDINTER)HUBOCELAUDINTER, \n"
                + "TO_CHAR(FECHACELAUDINTER,'DD/MM/YYYY')FECHACELAUDINTER,\n"
                + "CONVERI_RESPUESTASGENERICAS(HUBOPRESMEDPRU)HUBOPRESMEDPRU, \n"
                + "MEDIOSPRUEBA,\n"
                + "CONVERI_RESPUESTASGENERICAS(CONTACUPROB)CONTACUPROB, \n"
                + "CONVERI_RESPUESTASGENERICAS(DICTAUTAPERJUICIO)DICTAUTAPERJUICIO, \n"
        ...
        encabezados.add("EtapaIntermediaID");
        encabezados.add("CarpetaID");
        encabezados.add("ImputadoID ");
        encabezados.add("ProcesoID");
        encabezados.add("Fecha del escrito de acusación ");
        encabezados.add("¿Hubo celebración de la audiencia intermedia?");
        encabezados.add("Fecha de la celebración de la audiencia intermedia ");
        encabezados.add("¿Hubo presentación de medios de prueba?");
        encabezados.add("Medios de prueba (presentados /excluidos)");
        encabezados.add("¿Contó con acuerdos probatorios? ");
        encabezados.add("¿Se dictó auto de apertura a juicio oral?");

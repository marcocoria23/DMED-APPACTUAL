...
public class ExportaPProceso {
    ...
    public void exportaPProceso(String Entidad, String Periodo, String csvFile) throws SQLException {
        ...
        encabezados.add("Numero de asunto asignado a la causa penal ");
        encabezados.add("Etapa procesal en la que se encuentra el imputado");
        encabezados.add("Fecha de ingreso de la causa penal ");
        encabezados.add("¿Hubo celebracion de audiencia inicial?");
        encabezados.add("Motivo por el que no se celebro la audiencia inicial ");
        encabezados.add("Fecha de la audiencia inicial");
        encabezados.add("¿El asunto fue derivado a MASC?");
        encabezados.add("¿Se dicto suspension condicional del proceso?");
        encabezados.add("Estatus del proceso");

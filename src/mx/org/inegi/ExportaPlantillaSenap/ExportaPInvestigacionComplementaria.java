 ...
 */
public class ExportaPInvestigacionComplementaria {

    private ConOracle conexion = new ConOracle();
    private ResultSet resul;

    public void exportaPInvestigacionComplementaria(String Entidad, String Periodo, String csvFile) throws SQLException {
        ...
        String sql = "SELECT \n"
                ...
                + "IMPUTADOID,\n"
                + "PROCESOID, \n"
                + "CONVERI_RESPUESTASGENERICAS(FORMULACIONIMPUTACION)FORMULACIONIMPUTACION,\n"
                + "TO_CHAR(FECHAFORMIMP,'DD/MM/YYYY')FECHAFORMIMP,\n"
                + "CONVERI_RESOLUCIONAUTOVINCULACIONPRO(CATVINCPROSID)CATVINCPROSID,\n"
                + "TO_CHAR(FECHAVINCPROS,'DD/MM/YYYY')FECHAVINCPROS, \n"
                + "CONVERI_RESPUESTASGENERICAS(MEDIDACAUTELAR)MEDIDACAUTELAR,\n"
                + "TO_CHAR(FECHACIERREINV,'DD/MM/YYYY')FECHACIERREINV, \n"
                + "CONVERI_RESPUESTASGENERICAS(ACUSACION)ACUSACION, \n"
        ...
        encabezados.add("IDENTIICADOR ENTIDAD ");
        encabezados.add("InvestigacionComplementariaID");
        encabezados.add("CarpetaID");
        encabezados.add("ImputadoID ");
        encabezados.add("ProcesoID");
        encabezados.add("¿Hubo formulación de la imputación?");
        encabezados.add("Fecha de formulación de la imputación");
        encabezados.add("Resolución del auto de vinculación a proceso ");
        encabezados.add("Fecha en que se dictó el auto de vinculación a proceso (aplica si se vinculó a proceso)");
        encabezados.add("¿Se impuso medida cautelar?");
        encabezados.add("Fecha  del cierre de la investigación");
        encabezados.add("¿Se formuló acusación? ");
